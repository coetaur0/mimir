...
fn functions() {
    ...
    check_err(
        "fn f(x i32, y: 3) {}",
        vec![
            Error::UnexpectedToken("a ':'".to_string(), Spanned::new(Token::I32Kw, 7..10)),
            Error::UnexpectedToken(
                "a type expression".to_string(),
                Spanned::new(Token::IntLit, 15..16),
            ),
        ],
    );
    check_err(
        ...
        vec![Error::UnexpectedToken(
            "a type expression".to_string(),
            Spanned::new(Token::LBrace, 10..11),
        )],
    );
}
...
fn statements() {
    ...
    check_err(
        ...
        vec![Error::UnexpectedToken(
            "a type expression".to_string(),
            Spanned::new(Token::IntLit, 19..21),
        )],
    );
    check_err(
        "fn main() { x = }",
        vec![Error::UnexpectedToken(
            ...
            Spanned::new(Token::RBrace, 16..17),
        )],
    );
    check_err(
        "fn main() { return }",
        vec![Error::UnexpectedToken(
            "an expression".to_string(),
            Spanned::new(Token::RBrace, 19..20),
        )],
    );
}
...
fn expressions() {
    ...
    check_err(
        ...
        vec![Error::UnexpectedToken(
            "a '{'".to_string(),
            Spanned::new(Token::IntLit, 20..22),
        )],
    );
    check_err(
        "fn main() { f(x, y }",
    ...
    check_err(
        ...
        vec![Error::UnexpectedToken(
            ...
            Spanned::new(Token::TrueLit, 14..18),
        )],
    );
}
...
fn types() {
    ...
    check_err(
        ...
        vec![Error::UnclosedDelimiter(
            ...
            Token::RParen,
            Spanned::new(Token::LBrace, 15..16),
        )],
    );
}
